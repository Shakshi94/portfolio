...
function Home(){
    return(
        <>
        <div className={` bg-no-repeat bg-cover bg-center bg-local bg-[url('/public/images/backgroundimage.jpg')] max-w-screen-2xl container mx-auto px-4 md:px-20 bg-black text-white min-h-screen py-20`} id="Home">
