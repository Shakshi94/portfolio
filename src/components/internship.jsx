...
function Internship() {
  return (
    <div className="bg-black text-white max-w-screen-2xl container mx-auto px-4 md:px-20 py-20" id="Internship">
      ...
      <div className="flex flex-wrap lg:flex-row lg:justify-around sm:flex-col sm:items-center">
        {/* First Internship */}
            ...
            <CardContent>
              ...
              <Typography variant="body2" color="white" sx={{ margin: "10px 0" }}>
                <p className="text-justify">
                  Worked on developing and deploying web applications using HTML, CSS, JavaScript, Node.js, Express, and
                  MongoDB. Completed 3 projects including an employee management system, authentication systems, and BusyBuy.
                </p>
              </Typography>
        ...
        <div className="w-full sm:w-1/2 lg:w-auto mb-4">
          ...
          >
            <CardContent>
              ...
              <Typography variant="body2" color="white" sx={{ margin: "10px 0" }}>
                <p className="text-justify">
                  Gained hands-on experience in Git, version control, and cloud platforms like AWS and Azure. Learned and
                  implemented web development using the MERN stack (MongoDB, Express.js, React.js, Node.js). 
                </p>
              </Typography>
              <Typography variant="body2" sx={{ fontWeight: "bold" }}>
            ...
            <CardActions>
              <Button size="small" color="success" href="https://github.com/Shakshi94">
                <a href="https://drive.google.com/file/d/1G0NJWhoTkTn5F-7xUoZKoqeeK9KdVCIY/view?usp=sharing" target="blank">
                  View Certificate
                </a>
              </Button>
            </CardActions>
